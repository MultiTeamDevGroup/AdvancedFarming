package roburrito.advancedFarming.proxy;
...
public class ClientProxy extends CommonProxy {
	...
	public void registerItemRenderer(Item item, int meta, String id) {
		ModelLoader.setCustomModelResourceLocation(item, meta, new ModelResourceLocation(AdvancedFarming.MODID + ":" + id, "inventory"));
	}
